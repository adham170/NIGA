...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/adham170/Files_NIGGA/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1488653639,bot_id}
...
if result.sender_user_id_ == tonumber(1488653639) then
...
if result.id_ == tonumber(1488653639) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'NiGGa_SoUrcE')..')'
